...
namespace MailSender
{
    ...
    partial void DeleteEmail(Email instance);
		...
		public EmailsDataContext() : 
				base(global::MailSender.Properties.Settings.Default.DataSourceConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Email : INotifyPropertyChanging, INotifyPropertyChanged, IDataErrorInfo
	{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_Value", DbType = "NVarChar(MAX) NOT NULL",
			CanBeNull = false)]
		public string Value
		{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_Name", DbType = "NVarChar(MAX) NOT NULL",
			CanBeNull = false)]
		public string Name
		{
